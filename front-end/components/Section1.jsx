...
function Section1() {
  const { content, setContent, setTitleContent } = useContent();
  const router = useRouter();
  const onTextChange = (e) => {
    const data = e.target.value;
    setContent(data);
    setTitleContent(data.split(' ').slice(0, 5).join(' ') + '...');
  };
          ...
          <div id="main-multi-input">
            <div id="multi-input">
              ...
              <div id="input-wrapper" style={{ position: 'relative' }}>
                ...
                <div id="instruction-overlay" className={content ? '' : 'visible'}>
              ...
              <div id="search-multi" style={{ display: 'none' }}>
                ...
                <div>
                  ...
                  <div className="inlineblock" id="grammar-checker-error-btn">
                    <span id="qt-count-1714997442495" className="fixed-qt-gc-spinner" style={{ pointerEvents: 'auto' }}>
                      <span
